...
const DeviceConfirmationScreen = () => {
    ...
    <div className="SetwalletAddress4-div">
        ...
        <div className="SetWalletAddress4-div-main">
          ...
          <div className="SetWalletAddress4-container">
            ...
            <div className="SetWalletAddress4-container-back-div-text-main">DEVICE SUCCESFULLY ADDED!</div>
          </div>
        </div>
    </div>
  )
...
export default DeviceConfirmationScreen