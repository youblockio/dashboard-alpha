        ...
        <div className="home-coloumn">
            ...
            <div className="solar-cell-div">
                ...
                <div className="solar-cell-image-div">
                    <img src={solarPanelImage} alt="solar panel" className="solar-cell-image" />
                </div>
                <div className="solar-cell-image-div-text">Active Solar Cells: 120</div>
                <div className="weather-image-div">
                    <img alt='wheather' src={weatherImage} className="weather-image" />
                </div>
                <div className="tempratue-div">{Data && Data[0].data.currWea.currTemp} °C</div>
            ...
            <div className="weather-div">
                ...
                <div className="weather-div-array">
                    <img alt="group sun" src={groupSun} className="weather-div-array-image" />
                </div>
            ...
            <div className="consumption-div">
                ...
                <div className="self-production-div">
                    <div className="self-production-div-title">Self Production Today</div>
                    <div className="self-production-div-value">12 kWh</div>
                    <div className="self-production-image-div">
                        <img alt='down' src={downArrow} className="self-production-image" />
                    </div>
                </div>
                <div className="self-consumption-div">
                    <div className="self-production-div-title">Self Consumption Today</div>
                    <div className="self-production-div-value">12.2 kWh</div>
            ...
            <div className="vertical-menu-div">
                ...
                <div className="home-logo-div1" onClick={(e) => {e.preventDefault(); navigate("/dashboard");}}>
                <img src={home} alt='home' className="home1" />
                </div>
                <div className="wallet-logo-div1" onClick={(e) => {e.preventDefault(); navigate("/wallet");}}>
                <img src={walletlogo} alt='home' className="home1" />
                </div>
                <div className="setting-logo-div1" onClick={(e) => {e.preventDefault(); navigate("/settings");}}>
        ...
        <div className="graph-coloumn">
            ...
            <div className="geolocation">
                ...
                <div className="geolocation-center-div">
                    <div className="sunrise-div">
                        ...
                        <div className="sunrise-div-value">{Data && Data[0].data.currWea.sunrise}AM</div>
                    </div>
            ...
            <div className="block">
                <div className="block-mining-div">
                    <div className="block-mining-div-image"><img src={miner1} alt='mining' className='mining' /></div>
                ...
                <div className="block-energy-div">
                    <div className="block-mining-div-image"><img src={icon6} alt='mining' className='mining' /></div>
                ...
                <div className="block-grid-div">
                    <div className="block-mining-div-image"><img src={icon7} alt='mining' className='mining' /></div>
                    <div className="block-mining-div-title">Mining Consumption</div>
                    <div className="block-mining-div-value">2 kWh</div>
                </div>
                <div className="block-home-div">
                    <div className="block-mining-div-image"><img src={icon5} alt='mining' className='mining' /></div>
        ...
        <div className="profile-coloumn">
            ...
            <div className="picture-unit-div">
                ...
                <div className="cloudmining-image-div">
                    <img alt='storage' src={cloudMining} className="cloudmining-image-div-image" />
            ...
            <div className="emission-div">
                ...
                <div className="emission-div-title-1-value">{Data && Data[1].data.eqCO2Reduction} lbs</div>
                ...
                <div className="emission-div-title-2-value">{Data && Data[1].data.eqPlants}</div>
